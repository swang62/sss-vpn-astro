...
function WelcomeMsg({ name }: Props) {
  return (
    <p className="bg-muted w-full rounded-lg px-4 py-3">
      Welcome
      {name ? ` ${name}` : ""}! Looks like it's your first time here. This page contains important
      information about your current plan usage. Your profile is being set up right now, in the
      meantime, click{" "}
